		...
		<ul class="nav nav-tabs nav-tabs-left">
			...
			<li class="active">
            	<a href="#edit" data-toggle="tab"><i class="icon-wrench"></i> 
					<?php echo get_phrase('edit_report');?>
                    	</a></li>
            <?php endif;?>
			<li class="<?php if(!isset($edit_profile))echo 'active';?>">
            	<a href="#list" data-toggle="tab"><i class="icon-align-justify"></i> 
					<?php echo get_phrase('report_list');?>
                    	</a></li>
			<li>
		...
		<div class="tab-content">
			...
			<div class="tab-pane box active" id="edit" style="padding: 5px">
                <div class="box-content">
                    ...
                    <?php echo form_open('profissional/manage_prescription/edit/do_update/'.$row['prescription_id'] , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <select class="chzn-select" name="profissional_id">
										...
										?>
                                        	<option value="<?php echo $row2['profissional_id'];?>" <?php if($row2['profissional_id'] == $row['profissional_id'])echo 'selected';?>>
												<?php echo $row2['name'];?>
                                            </option>
                                        <?php
										endforeach;
                                    ...
                                    <div class="box closable-chat-box">
                                        <div class="box-content padded">
                                                ...
                                                <textarea name="case_history" id="ttt" rows="5" 
                                                	placeholder="<?php echo get_phrase('add_report');?>"><?php echo $row['case_history'];?></textarea>
                                                </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td align="center">
                            	<a href="<?php echo base_url();?>index.php?profissional/manage_prescription/edit/<?php echo $row['prescription_id'];?>"
                                	rel="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('edit');?>" class="btn btn-blue">
                                		<i class="icon-wrench"></i>
                                </a>
                            	<a href="<?php echo base_url();?>index.php?profissional/manage_prescription/delete/<?php echo $row['prescription_id'];?>" onclick="return confirm('delete?')"
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open('profissional/manage_prescription/create/' , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('profissional');?></label>
                                <div class="controls">
