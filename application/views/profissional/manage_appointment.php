		...
		<div class="tab-content">
			...
			<div class="tab-pane box active" id="edit" style="padding: 5px">
                <div class="box-content">
                    ...
                    <?php echo form_open('profissional/manage_appointment/edit/do_update/'.$row['appointment_id'] , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td align="center">
                            	<a href="<?php echo base_url();?>index.php?profissional/manage_appointment/edit/<?php echo $row['appointment_id'];?>"
                                	rel="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('edit');?>" class="btn btn-blue">
                                		<i class="icon-wrench"></i>
                                </a>
                            	<a href="<?php echo base_url();?>index.php?profissional/manage_appointment/delete/<?php echo $row['appointment_id'];?>" onclick="return confirm('delete?')"
