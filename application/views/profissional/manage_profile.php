			...
			<div class="tab-pane box active" id="list" style="padding: 5px">
                <div class="box-content padded">
                    ...
                    foreach($edit_profile as $row):
                        ?>
                        <?php echo form_open('profissional/manage_profile/update_profile_info/' , array('class' => 'form-horizontal validatable'));?>
		...
		<div class="tab-content">
			...
			<div class="tab-pane box active" id="list" style="padding: 5px">
                <div class="box-content padded">
                    ...
                    foreach($edit_profile as $row):
                        ?>
                        <?php echo form_open('profissional/manage_profile/change_password/' , array('class' => 'form-horizontal validatable'));?>
                                <div class="control-group">
