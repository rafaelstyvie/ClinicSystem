<link rel="stylesheet" href="<?php echo base_url();?>template/css/font.css">
        ...
        <link href="<?php echo base_url();?>template/css/clinica.css" media="screen" rel="stylesheet" type="text/css" />
        <!--[if lt IE 9]>
        ...
        <![endif]-->
        <script src="<?php echo base_url();?>template/js/clinica.js" type="text/javascript"></script>
